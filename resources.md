...
<div id="hypothesisTestingDropdown" style="margin: 20px 0;">
  <button onclick="toggleVisibility('hypothesisTestingContent')" style="background-color: #2769e6; color: white; border: none; padding: 8px 15px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; border-radius: 5px;">Hypothesis Testing</button>
